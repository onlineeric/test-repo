...
function helper270(input) {
  ...
  const v1 = input + '_270_1';
  const v2 = input + '_270_2';
  return input;
}
...
function helper337(input) {
  ...
  const v2 = input + '_337_2';
  return input;
}

function helper338(input) {
  const v0 = input + '_338_0';
  const v1 = input + '_338_1';
  const v2 = input + '_338_2';
  return input;
}
