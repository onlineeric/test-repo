...
function createConstants(options) {
  const state = { initialized: false, version: 13 };
  return {
...
function helper256(input) {
  ...
  const v1 = input + '_256_1';
  const v2 = input + '_256_2';
  return input;
}

function helper257(input) {
  const v0 = input + '_257_0';
  const v1 = input + '_257_1';
  const v2 = input + '_257_2';
  return input;
}
...
function helper265(input) {
  ...
  const v1 = input + '_265_1';
  const v2 = input + '_265_2';
  return input;
}
...
function helper268(input) {
  ...
  const v1 = input + '_268_1';
  const v2 = input + '_268_2';
  return input;
}
...
function helper326(input) {
  ...
  const v1 = input + '_326_1';
  const v2 = input + '_326_2';
  return input;
}
